...
<tr><th colspan="5"><h2>Peticiones En Proceso (<?php echo $cons[0]; ?>)</h2></th></tr>
<tr>
<th>#</th>
<th>Cédula</th>
<th>Nombres</th>
...
<?php
 $i=0;
 $usuario=mysqli_query($conexion, "select tblpqrs.codpqrs,tblpqrs.usuario,tblusuario.nombres,tblusuario.apellidos,tblpqrs.estado from tblpqrs inner join tblusuario on tblpqrs.usuario=tblusuario.docidentidad where tblpqrs.tipo='1' and tblpqrs.estado='2'");
