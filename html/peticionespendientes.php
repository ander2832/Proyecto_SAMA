...
$sql="SELECT COUNT(*) FROM tblpqrs where tipo='1' and estado='1'";
$consulta=mysqli_query($conexion,$sql);
$cons=mysqli_fetch_row($consulta);
?>
<br>
<table border="2" width="100%">
<tr><th colspan="5"><h2>Peticiones Pendientes (<?php echo $cons[0]; ?>)</h2></th></tr>
<!--nos muestra el resultado de la consulta(cantidad de peticiones pendientes)-->
<tr>
<th>#</th>
<th>Cédula</th>
<th>Nombres</th>
...
<?php
$i=0;
 $usuario=mysqli_query($conexion, "select tblpqrs.codpqrs,tblpqrs.usuario,tblusuario.nombres,tblusuario.apellidos,tblpqrs.estado from tblpqrs inner join tblusuario on tblpqrs.usuario=tblusuario.docidentidad where tblpqrs.tipo='1' and tblpqrs.estado='1'");
 while($usu=mysqli_fetch_array($usuario)){
	$i=$i+1; 
// hacemos una consulta para que nos muestre los datos de los usuarios que tienen peticiones pendientes
